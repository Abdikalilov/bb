// Группировка по папкам для лучшей читаемости и удобства поддержки.
...
// AboutPage компоненты
export { AboutBanner } from './aboutPageComponents/aboutBanner/AboutBanner';
